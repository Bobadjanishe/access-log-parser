...
public class Main {
    ...
    public static void main(String[] args) {
        String path = "D:\\Programms\\Java\\IdeaProjects\\AccessLogParser\\src\\access.log";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (len > 1024) {
                    throw new LineTooLongException("Найдена строка длиннее 1024 символов: " + len + " символов. Обработка прекращена.");
                }
